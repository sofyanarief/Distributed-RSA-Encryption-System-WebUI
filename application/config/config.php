...
$app_name = 'distributed_encryption';
/*
|--------------------------------------------------------------------------
| Base Site URL
|--------------------------------------------------------------------------
...
$config['sess_save_path'] = realpath($_SERVER["DOCUMENT_ROOT"]).'/application/cache/';
...
$config['csrf_token_name'] = 'csrf_token_'.$app_name;
$config['csrf_cookie_name'] = 'csrf_'.$app_name;
